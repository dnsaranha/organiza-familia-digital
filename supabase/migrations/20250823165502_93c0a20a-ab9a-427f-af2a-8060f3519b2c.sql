-- Family groups and sharing for scheduled tasks (corrected)
...
-- Add group_id to scheduled_tasks and update RLS for sharing
...
-- Drop old RLS policies for scheduled_tasks
...
-- New RLS policies for group sharing
